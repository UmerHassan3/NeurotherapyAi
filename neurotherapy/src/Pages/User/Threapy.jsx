...
import {
  ...
  Zap, Moon, Wind, Heart, Star, RefreshCw,
} from "lucide-react";
...
const ANALYSIS_STEPS = [
  ...
  "Preparing Wysa AI recommendations…",
];
  ...
  return (
    <div className="flex flex-col h-full">
      ...
      <div className="bg-violet-600 rounded-t-2xl px-4 py-3 flex items-center gap-3">
        ...
        <div>
          <p className="text-white font-semibold text-sm">Wysa · AI Wellness</p>
            ...
            <div className="mt-6 rounded-2xl border border-dashed border-violet-200 bg-white p-8 text-center space-y-4">
              ...
              <div>
                ...
                <p className="text-sm text-gray-500 mt-1 max-w-md mx-auto">
                  The app will read your brainwave signals and Wysa AI will recommend a personalised
                  meditation. No device? Use the dissertation dataset for a realistic demo.
                </p>
              </div>
              {error && (
